...
【**重要**】单引号和双引号包裹的话表示的含义不同！

- 用双引号包裹，那么会视为一个字符串
- 用单引号包裹，那么会视为一个 char 类型的数组！使用 `变量(index)` 可以取出某个字符。而双引号不行！
...
| API                                                 | 描述                              |
| --------------------------------------------------- | --------------------------------- |
| `figure(figsize=(x, y), dpi=y轴分辨率)`             | 创建画布                          |
| `plot(x轴数据列表, y轴数据列表, 'LineWidth', num1)` | 绘制折线图，`num1` 更设置线的粗细 |
| `bar(x, y)`                                         | 垂直条形图                        |
| `barh(x, y)`                                        | 水平条形图                        |
| `polarplot(弧度, 半径)`                             | 极坐标图                          |
| `sactter(x, y)`                                     | 散点图                            |
...
|                                           |                                                              |
|                                           |                                                              |
| `xticks(x要显示的刻度列表, **说明)`       | 添加自定义 x 刻度                                            |
| `yticks(y要显示的刻度列表, **说明)`       | 添加自定义 y 刻度                                            |
| `title('说明字符串')`                     | 添加标题                                                     |
| `xlabel('说明字符串')`                    | 添加 x 轴说明                                                |
| `ylabel('说明字符串')`                    | 添加 y 轴说明                                                |
| `xlim([起始值 结束值])`                   | x 轴的显示范围，起始值和结束值用空格隔开<br />（因为 MATLAB 默认会将 x 轴稍稍延后一点） |
| `grid("on")`<br />`grid on`               | 添加网格显示                                                 |
| `hold on`                                 | 保留当前图像                                                 |
| `axis square`                             | 强制所有轴为等长                                             |
| `axis([x轴起点 x轴终点 y轴起点 y轴终点])` | **更改显示范围**                                             |
...
![image-20220207191751837](doc/pic/README/image-20220207191751837.png)
...
<img src="doc/pic/README/image-20220207185240578.png" alt="image-20220207185240578" style="zoom:50%;" />
...
- **条形图**
    ...
    <img src="doc/pic/README/image-20220208174000603.png" alt="image-20220208174000603" style="zoom:50%;" />
...
- **极坐标图**
    ...
    <img src="doc/pic/README/image-20220208174037063.png" alt="image-20220208174037063" style="zoom:50%;" />
...
- **散点图**
    ...
    <img src="doc/pic/README/image-20220208174053845.png" alt="image-20220208174053845" style="zoom:50%;" />
